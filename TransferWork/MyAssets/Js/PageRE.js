...
$(function () {
    $.ajax({
        type: "GET",
        url: "/HandoverRE/Works/GetListWork",
...
// Event
{
    ...
    $(document).on("click", "[data-edit]", function (e) {
        ...
        $.ajax({
            type: "GET",
            url: "/HandoverRE/Works/GetWork/" + id,
            contentType: "application/json;charset=utf-8",
            dataType: "json",
            success: function (res) {
                if (res.success) {
    ...
    function DeteleWork() {
        ...
        $.ajax({
            type: "POST",
            url: "/HandoverRE/Works/DeleteWork/" + id,
            dataType: "json",
            success: function (res) {
                if (res.success) {
